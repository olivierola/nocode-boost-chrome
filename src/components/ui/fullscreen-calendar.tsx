                        ...
                        {day.events.slice(0, 2).map((event) => (
                          <div
                            ...
                            className={cn(
                              ...
                              event.type === 'ai' && "bg-primary/10 border-primary/20",
                              event.type === 'task' && "bg-secondary/10 border-secondary/20",
                              event.type === 'user' && "bg-muted/50"
                            )}
                          >
                          ...
                          {date.events.map((event) => (
                            <span
                              ...
                              className={cn(
                                ...
                                event.type === 'ai' && "bg-primary",
                                event.type === 'task' && "bg-secondary",
                                event.type === 'user' && "bg-muted-foreground"
                              )}
                            />
                          ))}
                        </div>
