  ...
  return (
    <div className="flex flex-col items-center mx-auto max-w-[350px] w-full">
      <div className="relative flex flex-col rounded-2xl p-[2px] overflow-hidden">
        ...
        {/* Chat Box */}
        <form onSubmit={handleSubmit} className="flex flex-col dark:bg-black/50 bg-white/20 rounded-xl w-full overflow-hidden border border-gray-200 dark:border-gray-800">
          ...
          <div className="flex justify-between items-end p-3">
            <div className="flex gap-3">
              <button type="button" className="flex text-black/20 dark:text-white/20 bg-transparent border-none cursor-pointer transition-all duration-300 hover:text-black dark:hover:text-white hover:-translate-y-1">
                <Image size={20} />
              </button>
              <button type="button" className="flex text-black/20 dark:text-white/20 bg-transparent border-none cursor-pointer transition-all duration-300 hover:text-black dark:hover:text-white hover:-translate-y-1">
                <BarChart2 size={20} />
            ...
            {/* Submit */}
            <button type="submit" disabled={disabled || !value.trim()} className="flex p-1 bg-gradient-to-t dark:from-gray-800 dark:via-gray-600 dark:to-gray-800 from-gray-400 via-gray-300 to-gray-500 rounded-lg shadow-inner border-none outline-none cursor-pointer transition-all duration-150 active:scale-95 disabled:opacity-50">
